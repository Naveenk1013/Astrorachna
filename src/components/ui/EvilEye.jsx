...
export default function EvilEye({
  ...
  useEffect(() => {
    ...
    // Set clear color to transparent so it blends well as a card back
    ...
    // Update to use window for global mouse tracking!
    ...
    // Setup resize observer instead of window resize for better containment in cards
