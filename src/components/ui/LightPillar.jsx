...
const LightPillar = ({
  ...
  // Lazy initializer: compute WebGL support once during initial render
  ...
  useEffect(() => {
    ...
    try {
      ...
      // WebGL not supported - component will render fallback
      return;
    }
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Output transparent alpha so it blends over the white background instead of writing solid black
